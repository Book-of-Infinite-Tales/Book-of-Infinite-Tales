...
/** A Treasure card that can be awarded as a named reward. */
...
export type BookComponents = {
  ...
  milieus?: Milieu[];
  quests?: Quest[];
  /** Fixed set of treasure cards for this game. When present, named treasure strings in rewards are validated against this list. */
  treasures?: Treasure[];
...
export type BookManifest = {
  ...
  components?: string;
  /**
   * Set to true if this book's content was wholly or partly generated by an
   * AI tool. Displayed as a notice in the reader so players can make an
   * informed choice about whether to use the book.
   */
  aiGenerated?: boolean;
};
